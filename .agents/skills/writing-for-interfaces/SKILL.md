...
- A `AGENTS.md`, `AGENTS.md`, or similar project config that defines voice and/or tone
...
5. **Capture it.** Suggest the user persist the voice definition somewhere durable
   (`AGENTS.md`, `AGENTS.md` or style guide document) so it persists across sessions. A word list pairs well with this and should be stored in the same file.
